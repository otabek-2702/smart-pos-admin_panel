...
function DateRangePicker(props) {
  ...
  const apply = () => {
    ...
    props.onChange({ from: f ? ymd(f) : "", to: t ? ymd(t) : "", preset: matchPreset(f, t, today) });
    setOpen(false);
  };
  ...
  return (
    <div className={cx("drp", props.size === "sm" && "drp--sm")} ref={ref}>
      ...
      {open && (
        <div className={cx("drp-pop", align === "right" && "drp-pop--right")}>
          ...
          <div className="drp-cal">
            <div className="drp-cal__head">
              ...
              <div className="drp-cal__titles">
                ...
                <span>{MONTHS[addMonths(view, 1).getMonth()]} {addMonths(view, 1).getFullYear()}</span>
              </div>
            ...
            <div className="drp-months" onMouseLeave={() => setHover(null)}>
              ...
              <MonthGrid month={addMonths(view, 1)} selFrom={from} selTo={to} hover={hover} today={today} max={today.getTime()} onPick={pick} onHover={setHover} />
            </div>
