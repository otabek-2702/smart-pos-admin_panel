...
(function () {
  ...
  var orders = [
    ...
    { id: 56, type: "DELIVERY", info: "—", status: "READY", payment: "PAID", total: 76000,  items: 2, at: "2026-06-13T19:35:39",
      methods: [ { type: "Cash", amount: 40000 }, { type: "Uzcard", amount: 36000 } ],
    ...
    { id: 55, type: "HALL", info: "Hall 1", status: "COMPLETED", payment: "PAID", total: 56000,  items: 1, at: "2026-06-13T17:25:51",
      methods: [ { type: "Cash", amount: 56000 } ],
    ...
    { id: 52, type: "HALL", info: "Hall 3", status: "COMPLETED", payment: "PAID", total: 788000, items: 7, at: "2026-06-13T17:03:38",
      methods: [ { type: "Cash", amount: 300000 }, { type: "Uzcard", amount: 338000 }, { type: "Payme", amount: 150000 } ],
  ...
  var ordersKpis = [
    { key: "total",     label: "Total",     value: 31, icon: "receipt", tone: "neutral", delta: 6.2, spark: [22,26,21,28,31,27,33,29,31] },
    { key: "preparing", label: "Preparing", value: 5,  icon: "clock",   tone: "warning", sub: "in kitchen now", spark: [3,5,4,6,5,7,4,5,5] },
    { key: "ready",     label: "Ready",     value: 2,  icon: "check",   tone: "success", sub: "to serve", spark: [1,2,3,2,1,2,3,2,2] },
    { key: "revenue",   label: "Revenue",   value: 10979000, money: true, icon: "wallet", tone: "primary", delta: 9.4, spark: [8.1,9.2,8.6,10.1,9.8,11.2,10.4,11.9,10.98] }
  ];
  ...
  var usersKpis = [
    { key: "total",  label: "Total",        value: 224, icon: "users",  tone: "primary", delta: 2.1, spark: [210,213,215,218,219,221,222,224] },
    { key: "active", label: "Active",       value: 10,  icon: "userok", tone: "success", sub: "on shift today", spark: [7,8,9,8,10,9,11,10] },
    { key: "depts",  label: "Departments",  value: 8,   icon: "dept",   tone: "info", sub: "across branches" },
    { key: "salary", label: "Total Salary", value: 248400000, money: true, icon: "wallet", tone: "neutral", delta: 1.4, spark: [238,240,242,244,245,247,248,248.4] }
  ];
