...
const NAV: NavEntry[] = [
  ...
  { type: 'item', id: 'stock-purchase-invoices', label: 'Supplier invoices', icon: 'inbox', to: '/stock/purchase-invoices', anyPermission: ['stock.purchase_invoice.view', 'stock.purchase_invoice.receive', 'stock.receiving.create', 'stock.receiving.complete'] },
