    ...
    <VCard>
      ...
      >
        ...
        <template #item.actions="{ item }">
          ...
          >
            <VBtn
              v-if="canPlan(item.raw)"
              icon
              variant="text"
              size="small"
              color="info"
              @click.stop="openAction(item.raw, 'plan')"
            >
              <VIcon
                size="18"
            ...
            <VBtn
              ...
              size="small"
              color="success"
              @click.stop="openAction(item.raw, 'start')"
            >
              <VIcon
                size="18"
                icon="bx-play"
            ...
            <VBtn
              ...
              size="small"
              color="primary"
              @click.stop="openAction(item.raw, 'complete')"
            >
              <VIcon
                size="18"
            ...
            <VBtn
              v-if="canHold(item.raw)"
              icon
              variant="text"
              size="small"
              color="warning"
              @click.stop="openAction(item.raw, 'hold')"
            >
              <VIcon
                size="18"
                icon="bx-pause"
            ...
            <VBtn
              v-if="canResume(item.raw)"
              icon
              variant="text"
              size="small"
              color="success"
              @click.stop="openAction(item.raw, 'resume')"
            >
              <VIcon
                size="18"
                icon="bx-play-circle"
